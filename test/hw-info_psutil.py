...
try:
	...
	while cont < 60:
		...
		insert = "insert into hwInfo (cpu_uso, cpu_freq, cpu_temp, gpu_uso, gpu_freq, gpu_temp, gpu_mem, ram_livre, ram_uso, hdd_temp, ssd_temp, net_uso, dataHora) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
