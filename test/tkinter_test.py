...
import numpy as np
from sexto_semestre.entraga_parcial.hw-info_psutil_BD import cpu_temp
...
lista_comp = OptionMenu(aba_quadro1, click1, "CPU", "GPU", "RAM", "HDD", "SSD", "Rede")
...
botao = Button(root, text="QUIT", fg="#ffffff", bg="#404142", command=quit, width=5)
#botao.grid()
botao.pack(side="top", padx=20, anchor="se")
...
botao4 = Button(aba_quadro2, text="pru", fg="#ffffff", bg="#404142", width=5)
botao4.grid(column=1, row=0, pady=40, sticky="s")



graf = FigureCanvasTkAgg(fig, aba_quadro1)
#graf.show()
graf.get_tk_widget().pack(side="top", padx=25, pady=25)
